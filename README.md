...
This repository will show you how to make LAN servers for Xash3D-FWGS.
...
Note that you need to have basic knowledge with Termux, either you will struggle in simple situations. Any issues with simple solution will be ignored.
...
3. Select all files inside the archive.
...
```
**Note: before starting the server, type "hostname <server name>", and "maxplayers <max player count>"**
...
**Note: i do not recommend doing this. Other players will have 150-200 ping on the server, better use VDS for hosting the server.**
